...
public class StoreTestPage extends AutomationBase{
   ...
   @Test(priority=1,enabled=true)
	...
	public void validateAddDatasToStore() throws IOException
	{
		...
		soft.assertEquals(storepg.getStoreEmailidFromSearchResults(),"miraj@gmail.com","Failure Message: Store emailid is not matched");
	...
	public void validateEditStoreDetails() {
		...
		soft.assertEquals(storepg.getStoreNameFromSearchResults(),"ANSStores","Failure Message: Store Name is not matched");
		soft.assertEquals(storepg.getStoreEmailidFromSearchResults(),"shibis@gmail.com","Failure Message: Store emailid is not matched");
		soft.assertEquals(storepg.getStorePhoneNoFromSearchResults(),"8876552872","Failure Message: Store Phoneno is not matched");
		soft.assertEquals(storepg.getStoreCountryFromSearchResults(),"INDIA","Failure Message: Store Country is not matched");
